...
2. **Select Template**: Use complexity score from src/prb-templates/
3. **Load Template**: From src/prb-templates/ hierarchy ONLY
4. **Resolve ALL Placeholders**: Transform to actual project values
5. **Validate NO Placeholders**: ZERO unresolved placeholders remain
6. **Validate All Sections**: ALL mandatory template sections present
7. **Block Runtime Config**: NO config lookups during execution

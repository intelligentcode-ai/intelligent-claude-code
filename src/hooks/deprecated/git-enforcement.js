...
const GIT_PRIVACY_PATTERNS = getSetting('git.privacy_patterns', [
  // Co-Authored-By attribution (block all when privacy=true)
  "Co-Authored-By:",
  "Co-authored-by:",
  ...
  "anthropic.com",
  "openai.com"
  // NOTE: Removed "Claude assisted", "AI assisted" - those could block legitimate work
]);
...
function main() {
  ...
  function stripAIMentions(message, patterns) {
    ...
    // Build regex patterns for AI attribution (not general AI mentions)
    const regexPatterns = [
      // Co-Authored-By attribution (block all when privacy=true)
      /Co-Authored-By:.*$/gim,
      /Co-authored-by:.*$/gim,
      ...
      /Generated with \[[^\]]+\]\([^)]+\)\s*/gi,
      /\n\n🤖 Generated.*$/s,
      /Generated with [A-Za-z ]+\s*$/gim,
      /Generated by [A-Za-z ]+\s*$/gim
    ];
    ...
    if (config.git && config.git.privacy === true && isGitCommit) {
      ...
      if (commitMessage) {
        ...
        const regexPatterns = [
          ...
          /🤖 Generated with \[[^\]]+\]\([^)]+\)/gi,
          /Generated with \[[^\]]+\]\([^)]+\)/gi,
          /Generated with [A-Za-z ]+$/gim,
          /Generated by [A-Za-z ]+$/gim
        ];

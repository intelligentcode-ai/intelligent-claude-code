...
### Documentation
- **Configuration Documentation**: Added `enforcement.block_all_capitals_filenames` to schema and configuration guide
  - src/schemas/icc.config.schema.json: Added property with type, default, description
  - docs/configuration-guide.md: Added comprehensive documentation with examples and behavior explanation
  - Setting controls whether all-capitals filenames (e.g., SUMMARY.md) are blocked or warned
  - Default: false (warns but allows), configurable to true (blocks entirely)
  - Applies to both Write tool and Bash file creation operations

...
### Fixed
- Added intelligent query vs command classification to restore system balance
- Enhanced detection patterns to distinguish questions from demands
- Preserved natural @Role conversations while maintaining PRB enforcement for work

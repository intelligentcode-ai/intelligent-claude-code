...
### Fixed
- Preserved natural @Role conversation flow for queries and discussions
- Added conversation exceptions to prevent PRB triggers for questions
- Maintained enforcement for actual work commands while allowing natural interaction
